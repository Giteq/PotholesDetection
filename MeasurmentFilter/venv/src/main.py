...
if __name__ == "__main__":
    ...
    test_poles = [[4, 8, 10, 11, 15, 18, 20],
                  ...
                  [4, 8, 11, 12, 21, 24, 27, 30, 34, 36, 39, 41, 43, 46, 48, 53, 63],
                  [], # 13 pomiar zakręt pod góre
                  [6, 8, 11, 14, 17, 20, 23, 25, 27, 30, 34, 37, 39, 42, 45, 48, 50, 53, 56, 69, 72, 83, 106, 110, 115, 122, 124, 127, 130, 131, 132, 136] # 14 poiar fajny do pokazania prędkości
                  ]
    time_test = [15, 73, 76, 132, 140]
    i = 0
    results = [0, 0, 0]
